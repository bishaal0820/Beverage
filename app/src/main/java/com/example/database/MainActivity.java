...
public class MainActivity extends AppCompatActivity {
   ...
   // private FirebaseStorage mStorageRef = FirebaseStorage.getInstance();
    ...
    public void setUpRecyclerView(){
        ...
        Toast.makeText(this, "query = " + query.toString(), Toast.LENGTH_SHORT).show();
        ...
        adapter.setOnItemClickListener(new MainAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Log.wtf("tag","hahahaha "+ mainData.getBrewed());
                ...
                String di = mainData.getBrewery();
                Log.wtf("tag","hahahaha "+ di);
                Log.wtf("tag","hahahaha "+ mainData.getBrewed());
                ...
                Toast.makeText(MainActivity.this,
                        "Position: " + position + " ID: " + mainData.getBrewed(), Toast.LENGTH_SHORT).show();
